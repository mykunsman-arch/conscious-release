  ...
  const faqs = [
    {
      ...
      answer: "טיפול בודד נמשך בין 60-90 דקות. מספר המפגשים משתנה בהתאם לצורך האישי - חלק מהאנשים מרגישים שינוי כבר אחרי 2-3 מפגשים, ואחרים מעדיפים תהליך ארוך יותר."
    },
    {
      question: "האם זה מתאים לילדים?",
      answer: "בהחלט! הטיפול מתאים לילדים החל מגיל 4-5 ומעלה. העבודה עם ילדים היא עדינה, משחקית ומותאמת לגילם. ראינו תוצאות מצוינות בנושאים כמו טיקים, הרטבה, חרדות וקשיי התנהגות."
    },
    {
