          ...
          <nav className="flex gap-1 md:gap-6 lg:gap-8 mx-auto flex-wrap justify-center ml-28 md:ml-0">
            {[
              ...
              <button
                ...
                className="relative text-xs md:text-xl lg:text-2xl font-medium text-foreground/70 hover:text-accent transition-colors group whitespace-nowrap px-0.5 md:px-0"
              >
                {item.label}
