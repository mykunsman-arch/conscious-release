    ...
    >
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center relative">
          <nav className="flex gap-2 md:gap-6 lg:gap-8 mx-auto flex-wrap justify-center ml-20 md:ml-0">
            {[
              ...
              <button
                ...
                className="relative text-xs md:text-xl lg:text-2xl font-medium text-foreground/70 hover:text-accent transition-colors group whitespace-nowrap px-1 md:px-0"
              >
                {item.label}
